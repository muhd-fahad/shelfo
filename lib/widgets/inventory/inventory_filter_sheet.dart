...
class InventoryFilterSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer3<ProductProvider, CategoryProvider, BrandProvider>(
      builder:
          (context, productProvider, categoryProvider, brandProvider, child) {
            return Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: [
                        SFOChip(
                          label: "All",
                          isSelected:
                              productProvider.selectedFilterCategories.isEmpty,
                          onSelected: (val) =>
                              productProvider.toggleFilterCategory(null),
                        ),
                        ...categoryProvider.categories.map(
                          (c) => SFOChip(
                            label: c.name,
                            isSelected: productProvider.selectedFilterCategories
                                .contains(c.name),
                            onSelected: (val) =>
                                productProvider.toggleFilterCategory(c.name),
                          ),
                        ),
                      ],
                    ),
                    ...
                    Wrap(
                      ...
                      children: [
                        SFOChip(
                          label: "All",
                          isSelected:
                              productProvider.selectedFilterBrands.isEmpty,
                          onSelected: (val) =>
                              productProvider.toggleFilterBrand(null),
                        ),
                        ...brandProvider.brands
                            ...
                            .map(
                              (b) => SFOChip(
                                label: b.name,
                                isSelected: productProvider.selectedFilterBrands
                                    .contains(b.name),
                                onSelected: (val) =>
                                    productProvider.toggleFilterBrand(b.name),
                              ),
                            ),
                      ],
                    ),
                          ...
                          .map(
                            (status) => SFOChip(
                              ...
                              isSelected: status == "All"
                                  ...
                                  : productProvider.stockStatuses.contains(
                                      status,
                                    ),
                              onSelected: (val) =>
                                  productProvider.toggleStockStatus(status),
                            ),
                          )
                          .toList(),
                    ),
                      ...
                      children: [
                        SFOChip(
                          ...
                          isSelected: productProvider
                              ...
                              .isEmpty,
                          onSelected: (val) =>
                              productProvider.toggleFilterProductType(null),
                        ),
                        ...ProductType.values.map(
                          (type) => SFOChip(
                            ...
                            isSelected: productProvider
                                ...
                                .contains(type),
                            onSelected: (val) =>
                                productProvider.toggleFilterProductType(type),
                          ),
                        ),
                      ],
                    ),
                        ...
                        Expanded(
                          child: SFOInputField(
                            ...
                            validator: (value) {
                              ...
                              final min =
                                  double.tryParse(
                                    productProvider.minPriceController.text,
                                  ) ??
                                  0.0;
                              if (max != null && max < min) {
                    ...
                    SFOButton(
                      text: "Apply Filter",
                      onPressed: () {
                        if (productProvider.filterFormKey.currentState
                                ?.validate() ??
                            false) {
                          ...
                          final max = double.tryParse(
                            productProvider.maxPriceController.text,
                          );
