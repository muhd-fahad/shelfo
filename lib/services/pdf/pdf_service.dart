      ...
      pw.MultiPage(
        ...
        build: (pw.Context context) {
          return [
            ...
            pw.Text("Payment Method: ${sale.paymentMethod}", style: const pw.TextStyle(fontSize: 10)),
            
            if (activePolicies.isNotEmpty) ...[
              pw.SizedBox(height: 30),
              pw.Text("TERMS & CONDITIONS / POLICIES", style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 12, color: PdfColors.grey900)),
              pw.Divider(color: PdfColors.grey400, thickness: 0.5),
              pw.SizedBox(height: 10),
              ...activePolicies.map((policy) => pw.Container(
                ...
                child: pw.Column(
                  ...
                  children: [
                    pw.Row(
                      mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                      children: [
                        pw.Text("${policy.name} (${policy.type.label})",
                            style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 9)),
                        pw.Text("Validity: ${policy.durationDays} Days",
                            style: const pw.TextStyle(fontSize: 8, color: PdfColors.grey700)),
                      ],
                    ),
                    pw.SizedBox(height: 2),
                    pw.Text(policy.description, style: const pw.TextStyle(fontSize: 8, color: PdfColors.grey800)),
                    pw.SizedBox(height: 4),
                    ...policy.conditions.map((condition) => pw.Padding(
                          ...
                          child: pw.Row(
                            ...
                            children: [
                              ...
                              pw.Expanded(
                                child: pw.Text(condition, style: const pw.TextStyle(fontSize: 7, color: PdfColors.grey700)),
                              ),
                            ],
                          ),
                        )),
